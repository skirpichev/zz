...
zz_gcdext(const zz_t *u, const zz_t *v, zz_t *g, zz_t *s, zz_t *t)
{
    ...
    tmp_s->negative = ((ISNEG(u) && ssize > 0)
                       || (!ISNEG(u) && ssize < 0));
    free(tmp_s_digits);
    tmp_s_digits = NULL;
    if (t) {
